...
const Projects = () => {
  ...
  const tex = useTexture(projects[0].image)
  const tex1 = useTexture(projects[1].image)
  const tex2 = useTexture(projects[2].image)
  const tex3 = useTexture(projects[3].image)
