...
type LampGLTFResult = {
  nodes: {
    Cylinder398_1: Mesh & { geometry: BufferGeometry };
    Cylinder398_2: Mesh & { geometry: BufferGeometry };
    Cylinder400_1: Mesh & { geometry: BufferGeometry };
    Cylinder400_2: Mesh & { geometry: BufferGeometry };
    Cylinder400_3: Mesh & { geometry: BufferGeometry };
  };
  materials: {
    brown: Material;
    black: Material;
...
export function Lamp(props: ThreeElements["group"]): JSX.Element {
  const { nodes, materials } = useGLTF("/models/Lamp.glb") as unknown as LampGLTFResult;
  return (
